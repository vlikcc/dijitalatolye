    ...
    <div class="bg-white">
      ...
      <section class="max-w-5xl mx-auto px-4 py-16 grid md:grid-cols-2 gap-10 items-center">
        <div>
          ...
          <h2 class="text-3xl font-extrabold text-slate-900">Misyonumuz</h2>
        ...
        <div>
          ...
          <h2 class="text-3xl font-extrabold text-slate-900">Vizyonumuz</h2>
          <p class="mt-3 text-slate-600 leading-relaxed">
      ...
      <section class="bg-slate-50 py-16">
        <div class="max-w-5xl mx-auto px-4">
          <h2 class="text-3xl font-extrabold text-slate-900 text-center">Değerlerimiz</h2>
          <div class="mt-10 grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            @for (v of values; track v.title) {
              <div class="rounded-2xl bg-white border border-slate-200 p-6 hover:border-brand-300 hover:shadow-md transition">
                ...
                <p class="mt-1.5 text-sm text-slate-600 leading-relaxed">{{ v.desc }}</p>
              </div>
            }
          </div>
        </div>
      ...
      <section class="py-20">
        <div class="max-w-4xl mx-auto px-4 text-center">
          <h2 class="text-3xl font-extrabold text-slate-900">Yolculuğumuza katılın</h2>
          <p class="mt-3 text-slate-600">İçerik üretmek, denetlemek veya keşfetmek — yeriniz hazır.</p>
          <div class="mt-6 flex justify-center gap-3">
            <a routerLink="/register" class="inline-flex items-center gap-2 px-5 py-3 rounded-xl bg-brand-600 text-white font-semibold hover:bg-brand-700 shadow-md shadow-brand-600/20">
              Hesap aç
              <mat-icon style="font-size:16px;width:16px;height:16px">arrow_forward</mat-icon>
            </a>
            <a routerLink="/discover" class="inline-flex items-center gap-2 px-5 py-3 rounded-xl border border-slate-200 text-slate-700 hover:border-brand-300 hover:text-brand-700">İçerikleri keşfet</a>
          </div>
        </div>
      </section>
    </div>
